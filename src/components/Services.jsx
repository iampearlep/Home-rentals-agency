...
const Services = () => {
  return (
    <div className="container mx-auto mt-20">
      <h2 className="text-lg md:text-2xl font-bold md:ml-10 capitalize text-center md:text-left mb-4 leading-relaxed md:mb-0">
        Minimum living cost takes care of everything{" "}
        <hr className="border-orange-600 -mt-8 ml-10 md:ml-0 md:-mt-0 w-52 border-t-0 border-b-2" />
      </h2>
      <div className="flex flex-col md:flex-row">
        <div>
          <img src={Cost} alt="" />
        </div>
        <div className="grid grid-cols-2 gap-x-4 gap-y-10 md:grid-cols-3 md:py-24">
