...
import {FaTwitter, FaYoutube, FaInstagram, FaGooglePlusG, FaRss} from 'react-icons/fa'
  ...
  return (
    <div className='container mx-auto mt-32 mb-16'>
      ...
      <div className='flex flex-col md:flex-row mx-auto justify-between w-9/12 my-12 gap-y-8' >
        ...
        <p className='flex flex-row gap-4'><HiLocationMarker className='text-orange-600' />345 Faulconer Drive, Suite 4 • Charlottesville, CA, 12345</p>
       <div className='flex flex-row justify-between mt-3 mb-5 '>
       <p className='flex flex-row gap-4'><HiPhone className='text-orange-600'/>(123) 456-7890</p>
        <p className='flex flex-row gap-4'><AiFillPrinter className='text-orange-600'/>(123) 456-7890</p>
       </div>
      ...
      <div className='flex flex-col md:flex-row justify-between mx-auto w-10/12 my-4 text-xs gap-y-6'>
        ...
        <div>
          <p className='capitalize'>Copyright © 2023 Minimumlivingcost @alwayspearlxx. All rights reserved</p>
        </div>
      </div>
    </div>
  )
