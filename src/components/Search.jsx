  ...
  return (
    ...
    transition: { duration: 1 },
            ...
            <img
              ...
              alt=""
            />
            <p className="text-sm md:text-md text-white font-semibold relative z-10 ml-8 -mt-40 md:ml-20 md:-mt-60 md:w-1/2">Flexible Leases</p>
          </motion.div>
          <motion.div
         whileHover={{
          scale: 0.9,
          transition: { duration: 1 },
            ...
            <img
              ...
              alt=""
            />
            <p className="text-sm md:text-md text-white font-semibold absolute z-10 ml-1 -mt-32 md:ml-2 md:-mt-48 w-2/5">7-Day Happiness Guaranteed</p>
          </motion.div>
          <motion.div
         whileHover={{
          scale: 0.9,
          ...
          className="">
            <img
              ...
              alt=""
            />
            <p className="text-sm md:text-md font-semibold text-white relative z-10 -mt-32 ml-7 w-2/3 md:-mt-48 md:ml-16 md:w-1/2">Monthly House Cleaning</p>
          </motion.div>
          <motion.div whileHover={{
    scale: 0.9,
    transition: { duration: 1 },
            ...
            <p className="text-sm md:text-md font-semibold text-white relative z-10 -mt-44 ml-12 md:-mt-64 md:ml-16 w-1/2"> Choose Your Own Roommate</p>
          </motion.div>
        </div>
        <div className="w-11/12 md:w-1/2 flex flex-col justify-center items-center md:justify-start md:items-start mt-32 mx-auto">
          ...
          <motion.button whileTap={{ scale: 0.8 }} className="bg-orange-600 rounded-md text-white text-xs px-4 py-3">
            Search Rooms
          </motion.button>
        </div>
      </div>
