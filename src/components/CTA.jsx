  ...
  return (
    <div className="container mx-auto mt-32 md:mt-72">
      ...
      <div
        ...
        className="flex flex-col items-center justify-center mx-auto shadow-2xl rounded-lg w-11/12 md:w-9/12"
      >
        <h2 className="text-xl text-orange-600 font-bold mt-8 mb-14">
          Add A New Property
        </h2>
        <form className="grid grid-cols-1 w-10/12 md:grid-cols-3 md:w-10/12 gap-6">
          ...
          <div className="flex flex-col">
            <label htmlFor="unitNumber" className="text-sm font-semibold mb-1">
          ...
          <div className="flex flex-col">
            <label htmlFor="roomType" className="text-sm font-semibold mb-1">
          ...
          <div className="md:col-start-1 md:col-end-4 text-center mt-8 mb-10">
            <motion.button
              ...
              className="bg-orange-600 text-white text-sm rounded-md px-20 md:px-28 py-4"
            >
              Add New Property
            </motion.button>
          </div>
